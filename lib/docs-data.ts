...
export const docsNavigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Connections", href: "/docs/features/connections" },
      { title: "Search", href: "/docs/features/search" },
      { title: "Keyboard Shortcuts", href: "/docs/features/keyboard-shortcuts" },
      { title: "Templates", href: "/docs/features/templates" },
    ],
  },
  {
    title: "Use Cases",
    items: [
      { title: "Daily Journaling", href: "/docs/use-cases/daily-journaling" },
      { title: "Project Management", href: "/docs/use-cases/project-management" },
      { title: "Research", href: "/docs/use-cases/research" },
      { title: "Knowledge Base", href: "/docs/use-cases/knowledge-base" },
    ],
  },
  {
    ...
    items: [
      ...
      { title: "Real-time Chat", href: "/docs/real-time-chat" },
    ],
  },
  {
    title: "Resources",
    items: [
      { title: "Video Tutorials", href: "/docs/video-tutorials" },
      { title: "Webinars", href: "/docs/resources/webinars" },
      { title: "Case Studies", href: "/docs/resources/case-studies" },
    ],
  },
  {
    title: "Support",
...
export const searchableContent = [
  ...
  },
  {
    ...
    href: "/docs/quick-start",
    category: "Getting Started",
    keywords: ["tutorial", "beginner", "first steps"],
  },
  {
    title: "Core Concepts",
    href: "/docs/core-concepts",
    category: "Getting Started",
    keywords: ["basics", "fundamentals", "overview"],
  },
  ...
  // Features
  {
    ...
    category: "Features",
    keywords: ["notes", "writing", "markdown", "formatting"],
  },
  {
    title: "AI Assistant",
    href: "/docs/features/ai-assistant",
    category: "Features",
    keywords: ["ai", "assistant", "automation", "smart"],
  },
  {
    title: "Connections",
    href: "/docs/features/connections",
    category: "Features",
    keywords: ["links", "graph", "relationships", "network"],
  },
  {
    title: "Search",
    href: "/docs/features/search",
    category: "Features",
    keywords: ["find", "discover", "filter", "query"],
  },
  {
    title: "Keyboard Shortcuts",
    href: "/docs/features/keyboard-shortcuts",
    category: "Features",
    keywords: ["hotkeys", "shortcuts", "productivity"],
  },
  {
    title: "Templates",
  ...
  // Use Cases
  {
    ...
    href: "/docs/use-cases/daily-journaling",
    category: "Use Cases",
    keywords: ["journal", "diary", "reflection", "daily"],
  },
  {
    title: "Project Management",
    href: "/docs/use-cases/project-management",
    category: "Use Cases",
    keywords: ["projects", "tasks", "planning", "management"],
  },
  {
    title: "Research",
    href: "/docs/use-cases/research",
    category: "Use Cases",
    keywords: ["research", "academic", "citations", "sources"],
  },
  {
    title: "Knowledge Base",
    href: "/docs/use-cases/knowledge-base",
    category: "Use Cases",
    keywords: ["knowledge", "wiki", "documentation", "reference"],
  },
  ...
  // Integrations & API
  {
    ...
    keywords: ["integrations", "apps", "connect", "sync"],
  },
  { title: "API Reference", href: "/docs/api", category: "API", keywords: ["api", "development", "endpoints", "sdk"] },
  {
    title: "Real-time Chat",
    href: "/docs/real-time-chat",
    category: "Features",
    keywords: ["chat", "realtime", "collaboration"],
  },
  ...
  // Resources
  {
    ...
    href: "/docs/video-tutorials",
    category: "Resources",
    keywords: ["videos", "tutorials", "learning"],
  },
  {
    title: "Webinars",
    href: "/docs/resources/webinars",
    category: "Resources",
    keywords: ["webinars", "events", "training"],
  },
  {
    title: "Case Studies",
    href: "/docs/resources/case-studies",
    category: "Resources",
    keywords: ["case studies", "examples", "success stories"],
  },
  ...
  // Support
  {
    ...
    category: "Support",
    keywords: ["help", "problems", "issues", "fix"],
  },
  { title: "FAQ", href: "/docs/faq", category: "Support", keywords: ["faq", "questions", "answers", "help"] },
]

export const featuredDocs = [
  {
    title: "Quick Start Guide",
    description: "Get up and running with Reflect in under 5 minutes",
    href: "/docs/quick-start",
    icon: "⚡",
  },
  {
    title: "AI Assistant",
    description: "Learn how to leverage AI to enhance your note-taking",
    href: "/docs/features/ai-assistant",
    icon: "🤖",
  },
  {
    title: "Daily Journaling",
    description: "Build a sustainable journaling practice with Reflect",
    href: "/docs/use-cases/daily-journaling",
    icon: "📔",
  },
  {
    title: "API Reference",
    description: "Integrate Reflect into your workflow with our API",
    href: "/docs/api",
    icon: "🔧",
  },
]
